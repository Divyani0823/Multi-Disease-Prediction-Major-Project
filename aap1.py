...
# Enhanced Title with colorful styles and symbols
st.markdown(
    """
    <div style="background-color:#FFA07A;padding:10px;border-radius:10px">
    <h1 style="color:#800000;text-align:center">🌟 Multi Disease Prediction Hub 🌟</h1>
    <h3 style="color:#333333;text-align:center">Your Comprehensive Health Prediction System 🩺</h3>
    </div>
    """,
    ...
    with st.form(key='cancer_form'):
        ...
        if submit:
            with st.spinner('Analyzing...'):
                ...
                if prediction == 1:
                    st.warning("⚠️ **Prediction: Cancer Present**")
                    st.markdown(
                        """
                        **Suggestion:** 
                        - Seek immediate medical consultation.
                        - Regular monitoring and follow-up tests.
                        - Explore treatment options with an oncologist.
